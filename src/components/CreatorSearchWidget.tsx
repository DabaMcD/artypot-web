...
export default function CreatorSearchWidget({
  ...
  const defaultInputClass =
    'w-full bg-surface-2 border border-border rounded-lg px-3 py-2.5 font-mono text-sm text-foreground placeholder:text-muted focus:outline-none focus:border-fan transition-colors';
