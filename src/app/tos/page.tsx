      ...
      <div className="max-w-3xl mx-auto px-4 pt-16 pb-24">
        ...
        <div className="space-y-0">
          ...
          <Section id="bounties" title="4. Bounties">
            ...
            <p><strong className="text-foreground">A bounty funds public work, not private perks.</strong> Backing is a contribution toward a result that is released publicly and equally to backers and non-backers alike. It is not a purchase of goods or services for the backer, and it confers no private benefit, ownership, exclusive access, or preferential treatment. Creators may not offer, and backers may not solicit or demand, any personal or backer-exclusive reward in exchange for a backing or its size — for example, private meetings, physical goods, personalized work, or an experience auctioned to the highest backer. The one form of recognition that remains permitted is a simple public acknowledgment of an individual backer by name, and only as a discretionary courtesy: a backer is never owed it, acquires no right to it, and has no claim if it is omitted, with the creator free to give or withhold it at their sole option.</p>
          ...
          <Section id="backing" title="5. Backing and Payments">
            ...
            <p><strong className="text-foreground">Refund and cancellation policy:</strong> You may cancel (revoke) any backing, free of charge and without giving a reason, at any time before The Council confirms the bounty complete — including while it is pending review. Once a bounty is confirmed complete, your backing is <strong className="text-foreground">locked</strong>: it can no longer be cancelled, and it will be charged in the next monthly billing run. Charged payments are <strong className="text-foreground">final and non-refundable</strong>. We may, at our sole discretion, review a refund request after a charge in cases of genuine hardship or verified fraud — <Link href="/support" className="text-fan hover:underline">contact support</Link> — but a post-charge refund is an exception we may grant, never an entitlement. This policy is also disclosed where you place a backing, in your backing confirmation email, in the pre-billing preview email, and on every receipt.</p>
            ...
            <p><strong className="text-foreground">Right of withdrawal (EU, UK, and similar consumer jurisdictions):</strong> If you are a consumer in a jurisdiction that grants a statutory right of withdrawal from distance contracts (such as the EU under Directive 2011/83/EU or the UK under the Consumer Contracts Regulations 2013), you are hereby informed that, to the extent a backing or any resulting charge is treated as such a contract, you have the right to withdraw from it within 14 days of placing the backing, without giving any reason and at no cost. To exercise this right, cancel the backing from your <Link href="/backings" className="text-fan hover:underline">backings page</Link>, or notify us by an unequivocal statement to <a href="mailto:legal@artypot.com" className="text-fan hover:underline">legal@artypot.com</a>. Because no money moves until a bounty completes, withdrawal before completion simply means you are never charged. Note that Artypot&apos;s standard back-out right is broader than the statutory minimum: you may cancel any backing, free of charge, at any time before The Council confirms the bounty complete — even after 14 days. <strong className="text-foreground">By placing a backing, you expressly request that performance begin before any withdrawal period expires, and you acknowledge that once the contract has been fully performed — that is, once The Council confirms the bounty complete and your card is charged — you lose your right of withdrawal.</strong> This disclosure is repeated in the confirmation email you receive when you place a backing and on each payment receipt.</p>
