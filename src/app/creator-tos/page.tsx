      ...
      <div className="max-w-3xl mx-auto px-4 pt-16 pb-24">
        ...
        <div className="space-y-0">
          ...
          <Section id="content" title="5. Content Rules">
            ...
            <p><strong className="text-foreground">5.4 Illegal content and protection of minors.</strong> You must never submit, facilitate, represent as a completion, or use a bounty to fund any content that: (a) sexualizes, exploits, or endangers a minor in any way; (b) is illegal under applicable law; (c) constitutes harassment, a credible threat, or targeted hate speech; or (d) contains malware or malicious code. This prohibition is absolute and applies to both on-platform material and any work delivered off-platform in fulfilment of a bounty.</p>
